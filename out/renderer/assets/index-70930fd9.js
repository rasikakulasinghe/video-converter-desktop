...
const FileVideo = createLucideIcon$1("FileVideo", [
  [
    "path",
    {
...
function App() {
  ...
  const [activeJobs, setActiveJobs] = reactExports.useState(/* @__PURE__ */ new Map());
  const [conversionSettings, setConversionSettings] = reactExports.useState({
    format: "mp4",
    quality: "medium",
  ...
  reactExports.useEffect(() => {
    if (!isElectron)
      return;
    const cleanupProgress = window.electronAPI.on.conversionProgress((progress) => {
      setActiveJobs((prev) => {
    ...
    const cleanupComplete = window.electronAPI.on.conversionComplete((result) => {
      setActiveJobs((prev) => {
        const updated = new Map(prev);
    ...
    const cleanupError = window.electronAPI.on.conversionError((error2) => {
      setActiveJobs((prev) => {
        const updated = new Map(prev);
        const job = updated.get(error2.jobId);
        if (job) {
          updated.set(error2.jobId, {
            ...job,
            status: "failed"
          });
        }
      ...
      setError(`Conversion failed: ${error2.error}`);
    });
    return () => {
      cleanupProgress();
      cleanupComplete();
  ...
  const handleOutputSelect = reactExports.useCallback(async () => {
    if (!isElectron || !selectedFile)
      return;
    try {
      setError(null);
  ...
  const handleStartConversion = reactExports.useCallback(async () => {
    if (!isElectron || !selectedFile || !outputPath)
      return;
    try {
      setError(null);
      setSuccess(null);
  ...
  const handleCancelConversion = reactExports.useCallback(async (jobId) => {
    if (!isElectron)
      return;
    try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileVideo, { className: "h-8 w-8 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: "Video Converter" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Convert your videos to web-optimized formats" })
        ] })
      ] }),
      isElectron && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "font-mono text-xs", children: [
        "Electron ",
        window.electronAPI.versions.electron
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container mx-auto px-6 py-8 pb-24 space-y-8", children: [
      isElectron && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-dashed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Test IPC channels to validate backend connectivity" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              size: "sm",
      ...
      success && /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileVideo, { className: "h-5 w-5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Select Video File" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Choose a video file to convert. Supported formats: MP4, AVI, MOV, MKV, WebM, FLV" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
          ...
          selectedFile && selectedFile.metadata && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg bg-muted/50 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-medium", children: selectedFile.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: selectedFile.extension.replace(".", "").toUpperCase() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Size:" }),
                " ",
                formatFileSize(selectedFile.metadata.fileSize)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Duration:" }),
                " ",
                formatDuration(selectedFile.metadata.duration)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Resolution:" }),
                " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Bitrate:" }),
                " ",
                Math.round(selectedFile.metadata.bitrate / 1e3),
                "k"
              ] })
            ] })
          ] })
      ...
      selectedFile && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center space-x-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Conversion Settings" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "Output Format" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  value: conversionSettings.format,
                  onValueChange: (value) => setConversionSettings((prev) => ({ ...prev, format: value })),
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "mp4", children: "MP4 (Recommended)" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "webm", children: "WebM" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "Quality" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "ultra", children: "Ultra Quality" })
                    ] })
                  ]
                }
              )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            outputPath && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-muted rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono break-all", children: outputPath }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
      ...
      activeJobs.size > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Active Conversions" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: Array.from(activeJobs.values()).map((job) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-medium", children: job.inputFile.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
                job.inputFile.extension.replace(".", "").toUpperCase(),
                " → ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: job.status === "completed" ? "default" : job.status === "failed" ? "destructive" : job.status === "processing" ? "secondary" : "outline",
                  children: job.status
                }
              ),
              job.status === "processing" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  size: "sm",
                  variant: "outline",
          ...
          job.status === "processing" && job.progress && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: job.progress.percentage, className: "h-2" }),
            job.progress.eta > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Estimated time remaining: ",
              formatDuration(job.progress.eta)
            ] })
          ] }),
          job.status === "failed" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { variant: "destructive", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertCircle, { className: "h-4 w-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDescription, { children: "Conversion failed" })
          ] }),
          job.status === "completed" && job.outputPath && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 bg-green-50 dark:bg-green-950/20 rounded border border-green-200 dark:border-green-800", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { className: "h-4 w-4 text-green-600" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: "Conversion completed!" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
      ...
      !isElectron && /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "h-4 w-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDescription, { children: "This application requires the desktop version to access file system operations and video conversion features." })
      ] })
    ] })
  ] });
}
